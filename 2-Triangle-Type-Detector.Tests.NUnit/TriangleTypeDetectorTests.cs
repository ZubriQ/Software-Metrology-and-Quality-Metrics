...
{
    private static void AssertTriangleType(double sideA, double sideB, double sideC, TriangleType expected)
    {
    ...
    public void TestTriangleTypeWithEquivalencePartitioning(double sideA, double sideB, double sideC, TriangleType expected)
    {
        AssertTriangleType(sideA, sideB, sideC, expected);
    }
    ...
    public void TestTriangleTypeWithBoundaryValues(double sideA, double sideB, double sideC, TriangleType expected)
    {
        AssertTriangleType(sideA, sideB, sideC, expected);
    }
    ...
    [TestCase(3, 4, 5, TriangleType.RightAngled)]
    public void TestTriangleTypeWithCausalAnalysis(double sideA, double sideB, double sideC, TriangleType expected)
    {
        AssertTriangleType(sideA, sideB, sideC, expected);
    }
}